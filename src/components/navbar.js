...
const Navbar = (props) => {
  return (
    ...
    >
      <header
        data-role="Header"
        className={projectStyles['navigation-container']}
      >
        ...
        <div
          ...
          className={` ${styles['BurgerMenu']} ${projectStyles['navigation-burger-menu']} `}
        ></div>
        <div
          data-type="MobileMenu"
          className={projectStyles['navigation-mobile-menu']}
        >
          <div className={styles['Nav1']}>
            ...
            <button
              className={` ${styles['PrimaryBtn']} ${projectStyles['button-primary']} ${projectStyles['button']} `}
            >
              {props.PrimaryBtn1}
            </button>
          </div>
